...
const cards = [
  { icon: Mail, title: "Email Us", sub: "We'll respond within 24 hours", value: "support@evermore.com" },
...
export default function Contact() {
  return (
    <div className="max-w-6xl mx-auto px-6 pt-10 pb-24">
      <h1 className="font-display text-4xl font-semibold mb-2">Contact Us</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
        {cards.map((c) => (
          <div key={c.title} className="bg-card border border-line rounded-2xl p-5">
