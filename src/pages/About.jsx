...
export default function About() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 pt-6 sm:pt-10 pb-16 sm:pb-24">
      ...
      <h1 className="font-display text-3xl sm:text-4xl font-semibold mb-6">Made to be worn, not archived.</h1>
      <p className="text-ink-soft text-base sm:text-lg mb-8 sm:mb-10 max-w-2xl">
        THE EVERMORE started as a small run of ten jackets sewn in a single workshop. We still work with the
